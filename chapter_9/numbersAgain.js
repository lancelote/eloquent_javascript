 ...
 * "5." and ".5" without also matching ".". For this, a good solution is to
 * use the | operator to separate the two cases—either one or more digits
 * optionally followed by a dot and zero or more digits or a dot followed by
 * one or more digits.
 *
