 ...
 * Object.defineProperty function. To compute the distance from (0, 0) to
 * (x, y), you can use the Pythagorean theorem, which says that the square of
 * the distance we are looking for is equal to the square of the x-coordinate
 * plus the square of the y-coordinate. Thus, √(x*x + y*y) is the number you
